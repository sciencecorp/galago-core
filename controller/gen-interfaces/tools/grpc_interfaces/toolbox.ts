...
export interface Command_RunPythonScript {
  ...
  as_module: boolean;
  blocking: boolean;
  env_variables?: { [key: string]: any } | undefined;
  conda_environment?: string | undefined;
...
export const Command_GetLiconicSensorData = {
  encode(message: Command_GetLiconicSensorData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.instrument_id !== "") {
      writer.uint32(10).string(message.instrument_id);
    }
    if (message.date !== "") {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.instrument_id = reader.string();
          continue;
        case 2:
          if (tag !== 18) {
            break;
  ...
  fromJSON(object: any): Command_GetLiconicSensorData {
    return {
      instrument_id: isSet(object.instrument_id) ? String(object.instrument_id) : "",
  ...
  toJSON(message: Command_GetLiconicSensorData): unknown {
    const obj: any = {};
    message.instrument_id !== undefined && (obj.instrument_id = message.instrument_id);
    message.date !== undefined && (obj.date = message.date);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Command_GetLiconicSensorData>, I>>(object: I): Command_GetLiconicSensorData {
    const message = createBaseCommand_GetLiconicSensorData();
    message.instrument_id = object.instrument_id ?? "";
    message.date = object.date ?? "";
    return message;
  },
};
...
export const Command_RunPythonScript = {
  encode(message: Command_RunPythonScript, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.python_file !== "") {
      writer.uint32(10).string(message.python_file);
    }
    if (message.as_module === true) {
      writer.uint32(16).bool(message.as_module);
    }
    if (message.blocking === true) {
      writer.uint32(24).bool(message.blocking);
    }
    if (message.env_variables !== undefined) {
      Struct.encode(Struct.wrap(message.env_variables), writer.uint32(34).fork()).ldelim();
    }
    if (message.conda_environment !== undefined) {
      writer.uint32(42).string(message.conda_environment);
    }
    if (message.use_shell !== undefined) {
      writer.uint32(48).bool(message.use_shell);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.python_file = reader.string();
          continue;
        case 2:
          if (tag !== 16) {
            break;
        ...
        case 4:
          ...
          message.env_variables = Struct.unwrap(Struct.decode(reader, reader.uint32()));
          continue;
        case 5:
          if (tag !== 42) {
            break;
          ...
          message.conda_environment = reader.string();
          continue;
        case 6:
          if (tag !== 48) {
            break;
  ...
  fromJSON(object: any): Command_RunPythonScript {
    return {
      python_file: isSet(object.python_file) ? String(object.python_file) : "",
      as_module: isSet(object.as_module) ? Boolean(object.as_module) : false,
      blocking: isSet(object.blocking) ? Boolean(object.blocking) : false,
      env_variables: isObject(object.env_variables) ? object.env_variables : undefined,
      conda_environment: isSet(object.conda_environment) ? String(object.conda_environment) : undefined,
      use_shell: isSet(object.use_shell) ? Boolean(object.use_shell) : undefined,
    };
  },

  toJSON(message: Command_RunPythonScript): unknown {
    const obj: any = {};
    message.python_file !== undefined && (obj.python_file = message.python_file);
    message.as_module !== undefined && (obj.as_module = message.as_module);
    message.blocking !== undefined && (obj.blocking = message.blocking);
    message.env_variables !== undefined && (obj.env_variables = message.env_variables);
    message.conda_environment !== undefined && (obj.conda_environment = message.conda_environment);
    message.use_shell !== undefined && (obj.use_shell = message.use_shell);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Command_RunPythonScript>, I>>(object: I): Command_RunPythonScript {
    const message = createBaseCommand_RunPythonScript();
    message.python_file = object.python_file ?? "";
    message.as_module = object.as_module ?? false;
    message.blocking = object.blocking ?? false;
    message.env_variables = object.env_variables ?? undefined;
    message.conda_environment = object.conda_environment ?? undefined;
    message.use_shell = object.use_shell ?? undefined;
    return message;
  },
};
