...
export const protobufPackage = "com.science.foundry.tools.grpc_interfaces.vspin";
...
export const Command = {
  encode(message: Command, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.spin_cycle !== undefined) {
      Command_Spin.encode(message.spin_cycle, writer.uint32(34).fork()).ldelim();
    }
    if (message.stop_spin_cycle !== undefined) {
      Command_StopSpin.encode(message.stop_spin_cycle, writer.uint32(42).fork()).ldelim();
    }
