  ...
  return (
    <Box position="relative" width="full" maxWidth="600px" margin="auto" mt="4">
      <Flex direction="column" alignItems="center">
        ...
        <Box mb="2">
        <Text >
          <Text as='b'>Time:</Text>{selectedImageTimeStamp}
        </Text>          
        </Box>
      ...
      <Flex justifyContent="center" alignItems="center">        
        ...
        <Box width={640} height={480}>
          <Image src={selectedImageBytes} alt={`slide-${currentIndex}`} borderRadius="lg" boxShadow="lg" />
        </Box>
        <IconButton
          aria-label=""
          icon={<FaArrowRight />}
      ...
      <Box mt={2}>
        <Button colorScheme={showLabeledImage ? "blue" : "gray"} onClick={()=>{setshowLabeledImage(!showLabeledImage)}}>{showLabeledImage ? "Hide Labels" : "Show Labels"} </Button>
      </Box>
      </Flex>
    </Box>
  );
