...
export const PF400: React.FC<PF400Props> = ({toolId, config}) => {
    ...
    const addToPath = async () => {
        ...
        try {
            ...
            setCurrentApproachPath(updatedLocations.find(loc => loc.name === currentTeachpoint)?.approachPath || []);
            toast({
                title: "Position Added",
                                        ...
                                        <Tr key={stepIndex}>
                                            ...
                                            {parseCoordinate(path).map((value, valueIndex) => (
                                                <Td key={valueIndex}>
                                                    <Input 
                                                        value={value}
                                                        onChange={(e) => handleApproachPathChange(stepIndex, valueIndex, e.target.value)}
                                                        readOnly={!isEditing}
                                                        bg={isEditing ? "yellow.100" : "white"}
                                                        size="sm"
                                                        textAlign="center"
                    ...
                    <ButtonGroup spacing='2' mt={4}>
                        {isEditing ? (
                            ...
                            <>
                                ...
                                {currentType === 'nest' && <Button onClick={addToPath} colorScheme='blue'>Add Current Pos to Path</Button>}
