      ...
      <Grid
        ...
        {Array.from({ length: maxRows }, (_, rowIndex) =>
          Array.from({ length: maxColumns }, (_, colIndex) => {
            const nest = instrumentNests.find(
                      ...
                      {plateMap[nest.id] ? (
                        <Flex>
                          <Checkbox
                            ...
                            onChange={(e) =>
                              handlePlateCheckBoxEvent(e.target.checked ? plateMap[nest.id] : null)
                            }
                            mr={1}
                            colorScheme="green"
                          />
                        ...
                        <Center
                          ...
                          <Checkbox
                            ...
                            onChange={(e) =>
                              handleNestCheckBoxEvent(e.target.checked ? nest : null)
                            }
                            colorScheme="green"
                          />
                        </Center>
    ...
    <Box>
      ...
      <Modal isOpen={isOpen} onClose={onClose} size={modalSize} scrollBehavior="inside">
        ...
        <ModalContent maxWidth="fit-content" maxHeight="fit-content" right="10%">
          <ModalHeader mt={4}>{selectedInstrument?.name}</ModalHeader>{" "}
          {/* Adjust the mt value as needed */}
          <ModalCloseButton />
          <ModalBody>
