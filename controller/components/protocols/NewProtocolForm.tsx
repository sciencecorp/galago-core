...
export const NewProtocolForm = () => {
  ...
  const [errors, setErrors] = useState<
    Partial<Record<keyof ProtocolFormData, string>>
  >({});
        ...
        {!hasWorkcells && (
          <Alert status="warning" borderRadius="md">
            ...
            <Box>
              ...
              <AlertDescription>
                You need to create a workcell before you can create a protocol.
                Please create a workcell first.
              </AlertDescription>
            </Box>
          </Alert>
        )}
        ...
        {!selectedWorkcell && hasWorkcells && (
          <Alert status="info" borderRadius="md">
            ...
            <Box>
              ...
              <AlertDescription>
                Please select a workcell from the workcell selector before
                creating a protocol.
              </AlertDescription>
            </Box>
          </Alert>
