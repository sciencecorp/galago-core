...
from db.models.settings_models import User, ApiKey
from db.auth import get_password_hash, encrypt_api_key, decrypt_api_key
...
def create_api_key(db, api_key):
    ...
    encrypted_key = encrypt_api_key(api_key.key_value)
    db_api_key = ApiKey(
